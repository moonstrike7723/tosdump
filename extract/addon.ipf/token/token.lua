...
--    value:ShowWindow(0);
  ...
  -- ?πÏãú???ÄÏ≤òÎüº Í≥†ÏÉù?òÏãú??Î∂ÑÏù¥ ?ùÍ∏∏Í∞Ä ?ÅÏäµ?àÎã§. ?¥Îãπ Î∂ÄÎ∂ÑÏ? ?†ÌÅ∞???§Ï†ú ?ÅÏö© ?úÍ∞Ñ???¨Ïú†Î∂ÑÏùÑ ?êÍ∏∞ ?åÎ¨∏??UI ??Ï∂úÎ†•?úÍ∞Ñ??Î≥¥Ï†ï?òÎäî Í≥≥ÏûÖ?àÎã§.
  -- ?¨Í∏∞ ?ëÏÑ± ?àÌïòÎ©?Í≥ÑÏÜç ?úÍ∞Ñ???¥ÏÉÅ?òÍ≤å ?òÏò¨Í±∞Ïóê??
...
function REQ_TOKEN_ITEM(parent, ctrl)
	...
	local indunResetItemList = {'Premium_indunReset','Premium_indunReset_14d','Premium_indunReset_14d_test','Premium_indunReset_1add','Premium_indunReset_1h',
							    ...
							    'Event_indunReset_Team_11','Event_indunReset_Team_12','Event_indunReset_Team_13'}
	if table.find(indunResetItemList,argList) ~= 0 then
		local etcObj = GetMyEtcObject();
		-- 2Í∞úÎøê?¥Ïó¨??Í≥†Ï†ï?ºÎ°ú ?£Ïñ¥??
