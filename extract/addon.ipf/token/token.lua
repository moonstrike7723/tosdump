...
function REQ_TOKEN_ITEM(parent, ctrl)
	...
	local indunResetItemList = {'Premium_indunReset','Premium_indunReset_14d','Premium_indunReset_14d_test','Premium_indunReset_1add','Premium_indunReset_1h',
							    ...
							    'Event_indunReset_Team_11', 'Tuto_indunReset_Team', 'Event_indunReset_Team_12', 'Event_indunReset_Team_13', 'Event_indunReset_Team_14','Event_indunReset_Team_17','Event_indunReset_Team_18'
                                                             ,'Event_indunReset_Team_19','Event_indunReset_Team_205','Event_indunReset_Team_25','Event_indunReset_Team_30','Event_indunReset_Team_31', 'Event_indunReset_Team_32'}
