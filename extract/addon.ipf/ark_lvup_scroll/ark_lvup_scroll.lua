...
function ARK_LVUP_SCROLL_RESULT(isSuccess)
...
function ARK_LVUP_SCROLL_UI_INIT()
	...
	text_title:SetTextByKey("value", ClMsg("ark_lvup_scroll"));
	...
	text_desc:SetTextByKey("value", TryGetProp(scrollObj, 'NumberArg1', 0))	
