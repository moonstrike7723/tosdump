...
function IS_ITEM_AWAKENING_STONE(obj)
	...
	elseif obj.ClassName == "Premium_awakeningStone" or obj.ClassName == "Premium_awakeningStone14" or obj.ClassName == "Premium_awakeningStone_TA" or
           ...
           or obj.ClassName == "Event_awakeningStone_15" or obj.ClassName == "Event_awakeningStone_18" or obj.ClassName == "Event_awakeningStone_19" or obj.ClassName == "Event_awakeningStone_20" or obj.ClassName == "Event_awakeningStone_205" then
		return true;
	end
